...
First off, thank you for considering contributing to xclint. It's people like you that make xclint such a great tool.
...
xclint is an open source project and we love to receive contributions from our community — you! There are many ways to contribute, from writing tutorials or blog posts, improving the documentation, submitting bug reports and feature requests or writing code which can be incorporated into xclint itself.
...
* Comply the [code of conduct](https://github.com/swift-xcode/xclint/blob/master/CODE_OF_CONDUCT.md) when you participate in the project.

# Your First Contribution

Unsure where to begin contributing to xclint? You can start by looking through these easy and thread issues:
...
Before suggesting a new feature, make sure that it aligns with the project philosophy, providing a tool to validate the format of the Xcode projects.

If you find yourself wishing for a feature that doesn't exist in xclint, you are probably not alone. There are bound to be others out there with similar needs. Many of the features that xclint has today have been added because our users saw the need. Open an issue on our issues list on GitHub which describes the feature you would like to see, why you need it, and how it should work.
